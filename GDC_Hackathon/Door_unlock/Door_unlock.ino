/**********************************************************************************
GDC Hackathon Mega Home Automation
Door Bell detection and unlock
...
String chatId = "5366538578";
String BOTtoken = "6695021624:AAG8Nnidz7nCl_vdkxXDOeeWngeGdjA7VcQ";
...
void loop(){
  ...
  if (sendPhoto){
    ...
    bot.sendMessage(chatId, r_msg, "Click.. Click.. Someone pressed the Door Bell!!");
    delay(200);
    sendPhotoTelegram(); 
    delay(100);
    sendPhoto = false;
